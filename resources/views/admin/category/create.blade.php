...
@section('content')
  <!-- Page title -->
  <h1 class="text-2xl font-semibold tracking-wide text-gray-600">Adding a category</h1>
  ...
  <form method="POST" action="{{route('categories.store')}}" class="space-y-5">
    ...
    <div class="space-y-2">
      ...
      <div class="w-3/5">
        <input type="text" name="name" placeholder="Category 1" autofocus class="w-full px-2 py-1 rounded-md placeholder-gray-300 outline-none focus:ring-0 text-gray-500 border border-gray-300 shadow">
        @error('name')
